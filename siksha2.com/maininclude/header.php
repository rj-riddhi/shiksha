                        ...
                        <div class="col-xl-6 col-lg-6 col-md-6 col-12">
                            <div class="header-contact-info d-flex" >
                                <div class="header-contact header-contact-phone">
                                    ...
                                    <p class="phone-number">(+91)7016843278</p>
                                </div>
                                <div class="header-contact header-contact-email">
                                    <span class="ti-email" style="color:#ffffff;"></span>
                                    <p class="email-name">shiksha@gmail.com</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                            <div class="header-social-icon-list">
                                <ul>
                                    ...
                                    <li><a href="#"><span class="ti-instagram" style="color:#ffffff;"></span></a></li>
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-xl-10 col-lg-10 col-md-6 col-6">
                            <div class="header-bottom-icon f-right">
                                <ul class="">
                                    <li class="toggle-search-icon mr-1"><a href="#"><span class="ti-search"></span>
                                    ...
                                    <li class="shopping-cart"><a class ="s-cart" href="cart.php"><span class="ti-shopping-cart"></span>
                                        ...
                                        if($result->num_rows == 1){
                                            ...
                                            echo '<a href="student/stu_dashboard.php" "><img title="My Profile" src="'. str_replace('..','.',$row["stu_img"]).'" alt="bbhjbhjb" style="height: 40px; width: 40px;" alt="image" class="rounded-circle"></a>';
                                    }
                                            ?>
                                            </li>
                                            ...
                                            if(isset($_SESSION['is_login'])){
                                                echo '
                                                   ...
                                                   '
                                                    ;
                                                    // <li>
                                                    //     <a href="student/stu_dashboard.php">MY PROFILE</a>
                                                    // </li>
                                            }else {
