...
<h2>Your Quiz Result</h2><br>
 ...
 <div class="card-header mt-5 bg-danger text-light">
  ...
  <button type="button" class="btn btn-primary mt-3" style="background-color:#181717;"><a href="../student/myCourse.php" style="text-decoration: none; color: white;">Back</a></button>
