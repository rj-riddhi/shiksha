 <!-- navigation bar starts -->
  ...
  <nav class="navbar navbar-expand-lg navbar-light fixed-top position-relative" style="background-color:#181717;">  <!--  postion relative to align the tab content  -->
  <a class="navbar-brand text-white" href="../index.php">Shiksha.com</a>
...
<?php 
 ...
 <table class="table table-hover table-bordered table-active">
  ...
  <tbody>
	...
	<input type="submit" class="btn btn-success" style="background-color:#181717;">
</form>
</div>
