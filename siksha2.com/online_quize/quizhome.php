...
extract($_POST);
$profile->show_users_profile($_SESSION['stuLogEmail']);  //calling the show_users profile() method of users class using users class object reference
  ...
  <!-- tab content start -->
   ...
   <div class="tab-content">
    ...
    <select class="form-control" id="exampleFormControlSelect1" name="selected_course">
      ...
      <option value="<?php echo $course['course_id'] ;?>"><?php echo $course['course_name']; ?></option>    <!-- displaying course name in dropdown -->
