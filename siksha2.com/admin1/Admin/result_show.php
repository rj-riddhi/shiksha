...
include("./admininclude/bootstrap_cdn_inc.php");
include("./users.php");
$res=new users;
//print_r($_POST);
...
<h2>Your Quiz Result</h2><br>
 ...
 <div class="card-header mt-5 bg-danger text-light">
  ...
  <!-- <button type="submit" class="mt-3 btn btn-danger "><a href="manage_quiz.php">Back</a></button> -->

  <button type="button" class="btn btn-danger mt-3" style="background-color: #000; border-color: #000"><a href="manage_quiz.php" style="text-decoration: none; color: white;">Back</a></button>
